...
{
    /// <summary>
    /// PDF ページの一括保存処理における進捗情報を保持する不変データオブジェクト
    /// </summary>
    /// <remarks>
    ...
    public sealed class SaveProgressReport
    {
        ...
        /*                                  プロパティ                                  */
        /********************************************************************************/
        /// <summary>処理の完了率 (0.0 ～ 100.0 の範囲)</summary>
        public double Percentage { get; }

        /// <summary>UI に表示するステータスメッセージ</summary>
        ...
        /// 進捗情報を初期化する
        /// </summary>
        /// <param name="percentage">完了率 (0.0 ～ 100.0 の範囲)</param>
